			...
			if (ChartElements.length > 0){
				...
				if (this.datasets && this.datasets.length > 1) {
					...
					new Chart.MultiTooltip({
						...
						chart: this.chart,
						chartOperating: this.chartOperating,
						ctx: this.chart.ctx,
...
(function(){
    ...
    var defaultConfig = {
		...
		// Force lines to be drawn to the edges of the chart (Used for average tresholds)
		drawLinesToEdges:false
    };
        ...
        draw : function(ease){
            ...
            helpers.each(this.lineDatasets,function(dataset,datasetIndex){
                ...
                helpers.each(pointsWithValues, function (point, index) {
                    ...
                    if (this.options.drawLinesToEdges) {
                        ctx.moveTo(this.scale.startPoint + 50, point.y);
                        ctx.lineTo(this.chart.width, point.y);
                    } else {
                        if (index === 0) {
                            ctx.moveTo(point.x, point.y);
                        }
