        ...
        <div class="container">
            <div class="screenheader">
                <h4> <opt:link controller="main" removeEntityId="true"><g:message code="main" /></opt:link> >
                    ...
                    > <g:message code="${operatingPeriod?.operatingPeriod}" dynamic="true"/> <br/> </h4>
        ...
        <div class="container section">
            <div class="sectionbody">
			    <div class="span4">
				    <div class="well">
						...
						<p>&nbsp;</p>
						<label><select id="selectChart"><option value="bar" selected="selected">Bar</option><option value="spider">Spider</option></select></label>
						<hr>
						<div id="chart_controls">
						    <h4><g:message code="graphs.operatingPeriods" /></h4>
          ...
          <script>
              $(document).ready(function() {
                  ...
                  <g:set var="entityAmount" value="${operatingPeriods ? operatingPeriods.size() : 0}" />
              ...
              var designs = [
                  <g:each in="${operatingPeriods}" var="entity" status="i">
                  {
                      id: ${i},
                      name: '${entity.operatingPeriodAndName}',
