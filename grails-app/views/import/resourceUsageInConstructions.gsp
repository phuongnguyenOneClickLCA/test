...
<div class="container">
    <div class="screenheader">
        <h1>Resource is used in the below constructions</h1>
    </div>
</div>
<div class="container section">
    <table class="table table-striped" style="margin-bottom: 10px; table-layout: fixed;">
        ...
        <g:each in="${resourcesInConstructions}" var="resourceInConstructions">
            ...
            <tr>
                <td style="width: 150px; word-wrap: break-word; white-space: normal;vertical-align:top;">${resourceId}</td>
                <td style="width: 150px; word-wrap: break-word; white-space: normal;vertical-align:top;">${profileId == "null" ? "" : profileId}</td>
                <td>
                    <g:each in="${resourceInConstructions.value}" var="construction">
