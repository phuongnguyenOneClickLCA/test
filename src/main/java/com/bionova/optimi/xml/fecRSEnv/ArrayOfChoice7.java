...
@XmlType(name = "ArrayOfChoice7", propOrder = {
    "masqueLointainAzimutalOrMasqueVertDroiteOrMasqueVertGauche"
})
public class ArrayOfChoice7 {
    ...
    protected List<Object> masqueLointainAzimutalOrMasqueVertDroiteOrMasqueVertGauche;

    /**
     * Gets the value of the masqueLointainAzimutalOrMasqueVertDroiteOrMasqueVertGauche property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the masqueLointainAzimutalOrMasqueVertDroiteOrMasqueVertGauche property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMasqueLointainAzimutalOrMasqueVertDroiteOrMasqueVertGauche().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getMasqueLointainAzimutalOrMasqueVertDroiteOrMasqueVertGauche() {
        if (masqueLointainAzimutalOrMasqueVertDroiteOrMasqueVertGauche == null) {
            masqueLointainAzimutalOrMasqueVertDroiteOrMasqueVertGauche = new ArrayList<Object>();
        }
        return this.masqueLointainAzimutalOrMasqueVertDroiteOrMasqueVertGauche;
    }
