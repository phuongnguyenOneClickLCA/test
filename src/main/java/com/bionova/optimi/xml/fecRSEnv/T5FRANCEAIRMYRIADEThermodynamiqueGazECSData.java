 ...
 * 
 * <p>Java class for T5_FRANCEAIR_MYRIADE_Thermodynamique_gaz_ECS_Data complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="T5_FRANCEAIR_MYRIADE_Thermodynamique_gaz_ECS_Data">
 *   &lt;complexContent>
...
@XmlType(name = "T5_FRANCEAIR_MYRIADE_Thermodynamique_gaz_ECS_Data", propOrder = {
    "name",
    "index",
    "description",
    "rdim",
...
@XmlSeeAlso({
    T5FRANCEAIRMYRIADEThermodynamiqueGazDSData.class
})
public class T5FRANCEAIRMYRIADEThermodynamiqueGazECSData {
