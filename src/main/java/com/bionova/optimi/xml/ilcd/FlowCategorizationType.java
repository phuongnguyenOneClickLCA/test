...
/**
 * <p>Java class for FlowCategorizationType complex type.
 * 
...
@XmlType(name = "FlowCategorizationType", namespace = "http://lca.jrc.it/ILCD/Common", propOrder = {
    "category",
    "other"
})
public class FlowCategorizationType {
