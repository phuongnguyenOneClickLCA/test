...
@XmlType(name = "ClassificationType", namespace = "http://lca.jrc.it/ILCD/Common", propOrder = {
    "clazz",
    "other"
})
public class ClassificationType {

    @XmlElement(name = "class", namespace = "http://lca.jrc.it/ILCD/Common", required = true)
