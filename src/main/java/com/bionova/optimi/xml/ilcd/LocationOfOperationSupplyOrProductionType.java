...
@XmlType(name = "LocationOfOperationSupplyOrProductionType", namespace = "http://lca.jrc.it/ILCD/Process", propOrder = {
    "descriptionOfRestrictions",
    "other"
})
public class LocationOfOperationSupplyOrProductionType {
