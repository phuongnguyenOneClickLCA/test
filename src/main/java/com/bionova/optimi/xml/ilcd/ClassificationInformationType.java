...
/**
 * <p>Java class for ClassificationInformationType complex type.
 * 
...
@XmlType(name = "ClassificationInformationType", namespace = "http://lca.jrc.it/ILCD/Common", propOrder = {
    "classification"
})
public class ClassificationInformationType {
