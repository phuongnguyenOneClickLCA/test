 ...
 */
class OptimiDefaultImportCellCollector implements OptimiImportCellCollector {

    static Log log = LogFactory.getLog(OptimiDefaultImportCellCollector.class)
    ...
    void reportCell(Cell cell, Object propertyConfiguration) {
        try {
            ...
            def message = [
					...
					but saw ${cellTypeToString[cell.cellTypeEnum]} field
				""" : """
					unexpected ${cellTypeToString[cell.cellTypeEnum]} field
				""")
            ]
    ...
    protected def severityLevel(Cell cell, Object propertyConfiguration) {
        def severityMapping = propertyConfiguration?.severityMapping ?: OptimiImportSeverityMappingEnum.IgnoreBlankWarningOtherwise
        severityMapping.severityLevel(cell.cellTypeEnum, propertyConfiguration?.expectedType)
    }
