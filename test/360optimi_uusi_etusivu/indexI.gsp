...
<head>
	...
	<link rel='stylesheet' type='text/css' href='http://fonts.googleapis.com/css?family=Droid+Sans:400,700|Open+Sans:400,600'>

	<script type="text/javascript" src="js/jquery-3.6.0.min.js"></script>
	<script type="text/javascript" src="js/jquery.scrollTo-min.js"></script>
	<script type="text/javascript" src="js/jquery.localscroll-min.js"></script>
	<script type="text/javascript" src="js/jquery.cycle.all.js"></script>
	<script type="text/javascript" src="js/jquery.bionova.home.js"></script>
...
<body class="home">
	...
	<div class="navbar">
		<div class="container">
			<a class="brand" href="#home">
				<asset:image src="img/logo.png" alt="360&deg; Optimi" />
			</a>
			<div class="links pull-left" style="padding-left: 20px;">
				<strong>
				<a href="#overview"><g:message code="index.services" /></a>
				<a href="#references"><g:message code="index.references" /></a>
				<a href="#benefits"><g:message code="index.features" /></a>
				<a href="#contacts"><g:message code="index.contact" /></a>
				</strong>
			</div>
			<div class="links pull-right logins">
				<a class="" href="#" data-toggle=".language">
			      <g:message code="index.language" />Kieli
				</a>			
					
				<a class="" href="#" data-toggle=".login">
					Kirjaudu
				</a>
				<a class="" href="#">
					Rekisteröidy
	...
	<div class="language">
		<div class="container">
          <opt:link controller="index" params="[lang:fi]">Suomi</opt:link><br />
          <opt:link controller="index" params="[lang:en]">English</opt:link>
		  <div class="clear"></div>
		</div>
	</div>
	...
	<div class="login">
		<div class="container">
			<form method="post" action="">
				<div>
					<input type="text"     class="left" name="username" placeholder="Email" value="" autocomplete="off" />
					<input type="password" class="left" name="password" placeholder="Password" value="" autocomplete="off" />
					<input type="submit"   class="left btn btn-orange" value="Login" />
					<div class="clear"></div>
					<label>
						<input type="checkbox" name="" />
						Muista minut
					</label>
					<a href="#" class="pull-right">Unohditko salasanasi?</a>
				</div>
			</form>
			<div class="clear"></div>
		</div>
	...
	<div class="content" id="home">
		<div class="container">
				...
				<div class="slides">
					...
					<div class="slide">
						...
						<div class="item">
							...
							<p>
								<a class="special-btn" href="#overview">
									<span class="btn">Lisää</span>
								</a>
							</p>
						</div>
						<div class="item">
					...
					<div class="slide">
						...
						<div class="item">
							...
							<p>
								<a class="special-btn" href="#benefits">
									<span class="btn">Lisää</span>
								</a>
							</p>
						</div>
			...
			<h2>Tunnusluvuilla tuloksellisuutta toimintaan</h2>
				...
				<div class="">
					<p>
						<a class="special-btn" href="#">
							<span class="btn">Rekisteröidy</span>
						</a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tilin luominen on ilmaista ja vie vain minuutin.
					</p>
				</div>
				<div class="clear"></div>
			</div>
...
<!--						<p>
				...
				<div class="half">
					...
					<div class="half">
						<p>
						<a href="${company.url}/sustainable_performance.html">
		...
		<div class="container">
			<div class="footer-column">
				...
				<p>
					...
					<a href="${company.url}">${company.name} Consulting</a>
				</p>
			</div>
			<div class="footer-column">
				<h3>Ota yhteyttä</h3>
				<p>
					<a href="${company.url}/yhteystiedot.html">Ota yhteyttä, ja <br>keskustellaan tarpeistanne</a>
				</p>
			</div>
			<div class="footer-column pull-right disabled">
				<p>
					Copyright 2013 ${company.name}<br />
